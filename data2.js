...
<div class="warn"><b>質量と重さの違い:</b> 質量(kg)は場所が変わっても不変。重さ(N)は重力の大きさで、月では地球の約6分の1になる。</div>`,
      quiz: [
        ...
        { q: "初速度0の物体が加速度3 m/s²で5秒間進んだときの速度はどれか。",
          c: ["8 m/s", "15 m/s", "0.6 m/s", "45 m/s"],
          a: 1, e: "v = v₀ + at = 0 + 3×5 = 15 m/s。等加速度運動の基本公式です。" },
        { q: "質量3kgの物体にはたらく重力の大きさはおよそ何Nか(g=9.8 m/s²)。",
          c: ["3 N", "約29 N", "約0.3 N", "9.8 N"],
          a: 1, e: "重さ(N)= 質量 × g = 3 × 9.8 = 29.4 N。質量(kg)に重力加速度を掛けると重力(N)になります。" },
        { q: "なめらかな水平面上で運動する物体に、進行方向の力も摩擦もはたらかないとき、物体はどうなるか。",
          c: ["だんだん速くなる", "等速直線運動を続ける", "すぐに止まる", "向きを変える"],
          a: 1, e: "合力が0なら、慣性の法則により物体は等速直線運動を続けます。力がなければ速さも向きも変わりません。" }
      ]
    },
    {
      id: "phys-2",
...
<li>日本の家庭用電源は<b>交流</b>。乾電池は<b>直流</b></li>
      ...
      quiz: [
        ...
        { q: "電圧が12V、抵抗が4Ωのとき、流れる電流はオームの法則より何Aか。",
          c: ["3 A", "48 A", "0.33 A", "16 A"],
          a: 0, e: "V = IR より I = V÷R = 12÷4 = 3 A。電圧を抵抗で割ると電流が求まります。" },
        { q: "波の速さが 340 m/s、振動数が 170 Hz のとき、波長は何mか。",
          c: ["2 m", "0.5 m", "510 m", "170 m"],
          a: 0, e: "v = fλ より λ = v÷f = 340÷170 = 2 m。速さを振動数で割ると波長になります。" },
        { q: "消費電力が同じとき、電力の式 P = VI から読み取れる関係として正しいものはどれか。",
          c: ["電圧を上げれば電流も必ず増える", "電圧を上げれば必要な電流は減る", "電圧と電流は無関係", "電力は電圧だけで決まる"],
          a: 1, e: "P = VI が一定なら、電圧Vと電流Iは反比例します。送電で高電圧にするのは、同じ電力を小さい電流で送り損失を減らすためです。" }
      ]
    }
  ]
},
...
<li><b>金属結合</b>:金属原子が自由電子で結びつく(電気をよく通す理由)</li>
      ...
      quiz: [
        ...
        { q: "水(H₂O)を構成する原子の結合として正しいものはどれか。",
          c: ["イオン結合", "共有結合", "金属結合", "水素結合のみ"],
          a: 1, e: "水は非金属の水素と酸素が電子を共有する共有結合でできた分子です。金属と非金属ならイオン結合になります。" },
        { q: "電子を1個失って陽イオンになったナトリウム原子は、どのように表されるか。",
          c: ["Na⁺", "Na⁻", "Na²⁺", "Cl⁻"],
          a: 0, e: "電子を1個失うと+の電気を1つ帯びるので Na⁺(ナトリウムイオン)。電子を受け取ると陰イオン(例:Cl⁻)になります。" },
        { q: "同位体(アイソトープ)の説明として正しいものはどれか。",
          c: ["陽子数が同じで中性子数が異なる原子", "陽子数が異なる原子", "電子の数だけが2倍の原子", "まったく別の元素"],
          a: 0, e: "同位体は原子番号(陽子数)が同じで、中性子数が異なるため質量数が違う原子どうしです。化学的性質はほぼ同じです。" }
      ]
    },
    {
      id: "chem-2",
...
<li>金属のイオンへのなりやすさ=<b>イオン化傾向</b>。大きい金属ほど酸化されやすい(さびやすい)</li>
      ...
      quiz: [
        ...
        { q: "pH が 3 の水溶液の性質として正しいものはどれか。",
          c: ["強い塩基性", "酸性", "中性", "アルカリ性"],
          a: 1, e: "pHは7が中性、7より小さいほど酸性が強い。pH3は酸性です。7より大きいと塩基性(アルカリ性)になります。" },
        { q: "標準状態で 44.8 L の気体は何molか(気体1mol=22.4 L)。",
          c: ["1 mol", "2 mol", "0.5 mol", "44.8 mol"],
          a: 1, e: "44.8 ÷ 22.4 = 2 mol。標準状態では気体の体積を22.4で割るとmolが求まります。" },
        { q: "アルカリ性(塩基性)の水溶液に共通する性質はどれか。",
          c: ["赤色リトマス紙を青色に変える", "青色リトマス紙を赤色に変える", "すっぱい味がする", "水素イオンを生じる"],
          a: 0, e: "塩基は水中で水酸化物イオンOH⁻を生じ、赤色リトマス紙を青色に変えます。青リトマスを赤にし、すっぱいのは酸の性質です。" }
      ]
    }
  ]
},
